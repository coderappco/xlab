...
import coderappco.xlab.utilidades.FilaDataTable;
import coderappco.xlab.utilidades.lazydata.LazyPacienteDataModel;
...
import coderappco.xlab.utilidades.ConversorDeNumerosALetras;
 ...
 * @author ArcoSoft-Pc1
 */
@Named(value = "facturarPacienteMB")
@SessionScoped
public class FacturarPacienteMB extends Controlador implements Serializable {
    ...
    private boolean validarCaja() {
        ...
        if (usuarioActual.getIdPerfil().getNombrePerfil().compareTo("SuperUsuario") == 0) {
            ...
            if (usuarioActual.getFacCajaList() == null ||usuarioActual.getFacCajaList().isEmpty()) {
                mensajeConfiguracion = "No se puede facturar: \n"
                        + "Paciente: " + pacienteSeleccionado.nombreCompleto() + " \n"
                        + "Razón: El usuario actual no tiene una caja asignada";
                return false;
            } else {
                listaCajas.add(usuarioActual.getFacCajaList().get(0));
    ...
    public void cargarDatosPaciente() {//System.out.println("cargarDatosPaciente");
        ...
        RequestContext.getCurrentInstance().update("IdFormFacturacion");
        RequestContext.getCurrentInstance().update("IdFormFacturacion:IdDialogSeleccionConsumos");
    }
...
//        }
    ...
    private boolean cargarFuenteDeDatosFactura() {
        ...
        nuevaFactura.setTituloFactura(empresaActual.getRazonSocial());
        ...
        nuevaFactura.setSubtituloFactura(empresaActual.getDireccion() + " - Tel1: " + empresaActual.getTelefono1() + " - Tel2: " + empresaActual.getTelefono2() + " - " + empresaActual.getWebsite());
        ...
        nuevaFactura.setFirmaAutoriza(SessionUtil.getUrlImagen()+ empresaActual.getLogo().getUrlImagen());
        nuevaFactura.setLogoEmpresa(SessionUtil.getUrlImagen() + empresaActual.getLogo().getUrlImagen());
    ...
    private boolean cargarFuenteDeDatosReciboCaja() {
        ...
        nuevoReciboCaja.setTituloFactura(empresaActual.getRazonSocial());
        nuevoReciboCaja.setRegimenEmpresa(empresaActual.getRegimen());
        nuevoReciboCaja.setNitEmpresa("NIT. " + empresaActual.getNumIdentificacion());
        nuevoReciboCaja.setCodigoDocumento("" + facturaSeleccionada.getCodigoDocumento());
        nuevoReciboCaja.setSubtituloFactura(empresaActual.getDireccion() + " - Tel1: " + empresaActual.getTelefono1() + " - Tel2: " + empresaActual.getTelefono2() + " - " + empresaActual.getWebsite());
        ...
        nuevoReciboCaja.setFirmaAutoriza(SessionUtil.getUrlImagen() + empresaActual.getLogo().getUrlImagen());
        nuevoReciboCaja.setLogoEmpresa(SessionUtil.getUrlImagen() + empresaActual.getLogo().getUrlImagen());
