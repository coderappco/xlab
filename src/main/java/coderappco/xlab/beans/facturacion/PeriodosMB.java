 ...
 * @author ArcoSoft-Pc1
 */
@Named(value = "periodosMB")
@SessionScoped
public class PeriodosMB extends Controlador implements Serializable {
    ...
    public void cambiaPeriodo() {//recalcular la fecha inicial, final y limite del periodo
        Date dp = new Date();
        dp.setDate(1);//dia
