...
public class CfgOpcionesMenu implements Serializable {
    ...
    @JoinTable(name = "cfg_opciones_menu_perfil_usuario", joinColumns = {
        @JoinColumn(name = "id_opcion_menu", referencedColumnName = "id_opcion_menu")}, inverseJoinColumns = {
    ...
    public String toString() {
        return "coderappco.xlab.entidades.CfgOpcionesMenu[ idOpcionMenu=" + idOpcionMenu + " ]";
    }
