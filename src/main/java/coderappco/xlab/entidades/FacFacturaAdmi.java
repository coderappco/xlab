...
public class FacFacturaAdmi implements Serializable {
    ...
    @Column(name = "valores_iva")
    private Double valoresIva;
    @Column(name = "valores_cree")
    private Double valoresCree;
    @Column(name = "valores_copago")
    private Double valoresCopago;
    @Column(name = "valores_cuota_moderadora")
    ...
    @Column(name = "valor_usuarios")
    private Double valorUsuarios;
    @Column(name = "clasificacion")
    private Integer clasificacion;
    @JoinTable(name = "fac_factura_admi_detalle", joinColumns = {
        @JoinColumn(name = "id_factura_admi", referencedColumnName = "id_factura_admi")}, inverseJoinColumns = {
        @JoinColumn(name = "id_factura_paciente", referencedColumnName = "id_factura_paciente")})
    @ManyToMany
    ...
    public String toString() {
        return "coderappco.xlab.entidades.FacFacturaAdmi[ idFacturaAdmi=" + idFacturaAdmi + " ]";
    }
