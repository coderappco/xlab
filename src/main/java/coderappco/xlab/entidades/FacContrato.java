...
public class FacContrato implements Serializable {
    ...
    @Size(max = 10)
    @Column(name = "numero_rip_contrato")
    ...
    @Column(name = "cpb")
    private Boolean cpb;
    @Column(name = "medicamento_valor_1")
    private Double medicamentoValor1;
    @Column(name = "medicamento_valor_2")
    private Double medicamentoValor2;
    @Column(name = "medicamento_valor_3")
    private Double medicamentoValor3;
    @Column(name = "insumos_porcentaje_1")
    private Double insumosPorcentaje1;
    @Column(name = "insumos_porcentaje_2")
    private Double insumosPorcentaje2;
    @Column(name = "insumos_porcentaje_3")
    ...
    public String toString() {
        return "coderappco.xlab.entidades.FacContrato[ idContrato=" + idContrato + " ]";
    }
