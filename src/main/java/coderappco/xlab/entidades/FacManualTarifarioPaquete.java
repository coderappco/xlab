 ...
 */
@Entity
@Table(name = "fac_manual_tarifario_paquete")
@XmlRootElement
@NamedQueries({
...
public class FacManualTarifarioPaquete implements Serializable {
    ...
    public String toString() {
        return "coderappco.xlab.entidades.FacManualTarifarioPaquete[ facManualTarifarioPaquetePK=" + facManualTarifarioPaquetePK + " ]";
    }
