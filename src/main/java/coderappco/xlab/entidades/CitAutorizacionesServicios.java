 ...
 */
@Entity
@Table(name = "cit_autorizaciones_servicios")
@XmlRootElement
@NamedQueries({
...
public class CitAutorizacionesServicios implements Serializable {
    ...
    @JoinColumn(name = "id_autorizacion", referencedColumnName = "id_autorizacion", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "coderappco.xlab.entidades.CitAutorizacionesServicios[ citAutorizacionesServiciosPK=" + citAutorizacionesServiciosPK + " ]";
    }
