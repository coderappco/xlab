 ...
 */
@Entity
@Table(name = "cfg_configuraciones")
@XmlRootElement
@NamedQueries({
...
public class CfgConfiguraciones implements Serializable {
    ...
    @Size(max = 100)
    @Column(name = "ruta_copias_seguridad")
    private String rutaCopiasSeguridad;
    @Size(max = 2147483647)
    @Column(name = "ruta_bin_postgres")
    ...
    public String toString() {
        return "coderappco.xlab.entidades.CfgConfiguraciones[ idConfiguracion=" + idConfiguracion + " ]";
    }
