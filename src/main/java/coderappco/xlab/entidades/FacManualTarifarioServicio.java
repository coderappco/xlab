 ...
 */
@Entity
@Table(name = "fac_manual_tarifario_servicio")
@XmlRootElement
@NamedQueries({
...
public class FacManualTarifarioServicio implements Serializable {
    ...
    public String toString() {
        return "coderappco.xlab.entidades.FacManualTarifarioServicio[ facManualTarifarioServicioPK=" + facManualTarifarioServicioPK + " ]";
    }
