 ...
 */
@Entity
@Table(name = "fac_factura_medicamento")
@XmlRootElement
@NamedQueries({
...
public class FacFacturaMedicamento implements Serializable {
    ...
    public String toString() {
        return "coderappco.xlab.entidades.FacFacturaMedicamento[ facFacturaMedicamentoPK=" + facFacturaMedicamentoPK + " ]";
    }
